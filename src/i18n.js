...
const resources = {
  uk: {
    translation: {
      ...
      ecobagColor: "Кольорові паперові торби з крученими ручками",
      ecobagWhite: "Білі паперові торби з крученими ручками",
      ecobagBrown: "Коричневі паперові торби з крученими ручками",
      ecobagText:
        "Паперові торби з крученими ручками польської фабрики <a href='https://ecobagnetwork.eu/' target='_blank rel='nofollow'>Ecobag Network</a> виготовлені з міцного паперу, що витримує вагу до 3-8 кг (залежно від розміру) і не псуються від вологи. Екологічне та комфортне пакування продукції.",
